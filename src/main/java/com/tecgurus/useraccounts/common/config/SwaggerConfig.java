package com.tecgurus.useraccounts.common.config;
...
public class SwaggerConfig {
    ...
    public Docket placesDocket() {
        return docket("UserAccounts", "/api-user-accounts/.*");
    }
    ...
    private Docket docket(String title, String path) {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.tecgurus.useraccounts"))
